...
vector<vector<bool>> RectBC::MakeRectArray(int Sites,float Prob){
    int i = 0;
    int j = 0;
    int Width;
    int Height;
...
tuple<int,int> RectBC::ArrayDimensions(int sites, float prob){
...
vector<int> RectBC::CenterOfMass(vector<vector<bool>> Array, int Height, int Width){
    int i = 0;
    int j = 0;
    float RowWeight = 0;
    float ColWeight = 0;
...
vector<vector<vector<int>>> RectBC::Bank(vector<vector<bool>> Array, int Range){
    vector<vector<vector<int>>> moves = {};
...
tuple<vector<bool>,vector<vector<int>>> RectBC::CompressRow(vector<bool> row, int center, int suff){
    int dim = row.size();
    float x = suff;
    x/=2;
...
vector<int> RectBC::RowSum(vector<vector<bool>> Array, int H, int W){
    vector<int> RowTotal;
    int dummy = 0;
    int i = 0;
    int j = 0;
...
vector<vector<bool>> RectBC::Transpose(vector<vector<bool>> Array, int dim){
    int i = 0;
    int j = 0;
...
bool RectBC::Check(vector<vector<bool>> Array, vector<int> RowRange, vector<int> ColRange){
    int i = RowRange[0];
    int j = ColRange[0];
    bool check = true;
    while(i<RowRange[1]){
...
tuple<vector<vector<bool>>,vector<int>,vector<int>,vector<int>,vector<vector<vector<int>>>> RectBC::Balance(vector<vector<bool>> Array, vector<int> Range, vector<int> COM, int Height,int Width, vector<int> RowTotal){
    vector<vector<vector<int>>> moves;
